...
urlpatterns += patterns('ampta.views.views',
    ...
    # register
    url(r'^register/$', 'new_create_user', name='new_user'),
    # users
    url(r'^users/$', 'user_index', name='users'),
    # users/1
    url(r'^users/(?P<user_id>\d+)/$', 'user_show', name='user'),
    # users/edit
    url(r'^users/edit/$', 'edit_update_user', name='edit_user'),
)
...
urlpatterns += patterns('ampta.views.project_views',
    ...
    # projects/1/comments/create
    url(r'^projects/(?P<project_id>\d+)/comments/create/$', 'create_comment', name='create_project_comment'),
    # projects/1/comments/1/delete
    url(r'^projects/(?P<project_id>\d+)/comments/(?P<comment_id>\d+)/delete/$', 'delete_comment', name='delete_project_comment'),
)
